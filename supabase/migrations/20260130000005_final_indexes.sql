-- BN-Aura: Final Performance Indexes (Correct Column Names)
...
-- Note: uses 'analyzed_at' not 'created_at'
...
CREATE INDEX IF NOT EXISTS idx_skin_analyses_analyzed_at ON public.skin_analyses(analyzed_at DESC);
...
-- appointment_slots already has clinic_id index from previous migration
