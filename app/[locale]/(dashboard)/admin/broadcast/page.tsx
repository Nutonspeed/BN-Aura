    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
        <div className="space-y-1">
          ...
          >
            ประกาศ<span className="text-primary">ทั่วระบบ</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            จัดการการส่งข้อความและการสื่อสารระหว่างคลินิก
          </motion.p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-2">
        {[
          { label: 'ความเร็วส่ง', value: '1.2ms', icon: Pulse, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
          { label: 'จำนวนคลินิก', value: '24 คลินิก', icon: Globe, color: 'text-primary', bg: 'bg-primary/10' },
          { label: 'อัตราสำเร็จ', value: '99.9%', icon: CheckCircle, color: 'text-blue-500', bg: 'bg-blue-500/10' }
        ].map((stat, i) => (
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              ...
              <Badge variant="ghost" className="bg-primary/5 text-primary border-none font-black text-[10px] tracking-widest uppercase px-4 py-1.5">ข้อความใหม่</Badge>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              ...
              <Badge variant="ghost" className="bg-secondary text-muted-foreground border-none font-black text-[10px] tracking-widest uppercase px-4 py-1.5">ข้อมูลย้อนหลัง</Badge>
            </div>
            <MessagesList />
          </div>
        </div>
        ...
        <div className="space-y-8">
          <Card className="p-8 rounded-[40px] border-border shadow-card relative overflow-hidden group">
            ...
            <div className="space-y-4 relative z-10">
              <p className="text-xs text-muted-foreground font-medium leading-relaxed italic border-l-2 border-primary/20 pl-4">
                ข้อความจะถูกส่งไปยังทุกคลินิกที่เลือกโดยอัตโนมัติ
              </p>
          ...
          <Card className="p-8 rounded-[40px] border-rose-500/10 bg-rose-500/[0.02] space-y-4 group">
            ...
            <p className="text-xs text-muted-foreground italic font-medium leading-relaxed">
              ตรวจสอบเนื้อหาก่อนส่ง เมื่อส่งแล้วไม่สามารถยกเลิกได้
            </p>
          </Card>
        </div>
      </div>
