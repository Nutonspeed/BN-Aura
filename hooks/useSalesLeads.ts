...
/**
 * Infinite Query for Paginated Leads
 * Use this for large lead lists with scroll-to-load-more
 */
export function useSalesLeadsInfinite(
  clinicId: string, 
  options?: { 
    status?: string;
    pageSize?: number;
  ...
  return useInfiniteQuery({
    queryKey: ['sales-leads-infinite', clinicId, options?.status],
