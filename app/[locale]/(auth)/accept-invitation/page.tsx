      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            You've been invited to join <span className="font-semibold">{invitation?.clinic_name}</span> as a <span className="font-semibold capitalize">{invitation?.role?.replace('_', ' ')}</span>
          </p>
        </div>
