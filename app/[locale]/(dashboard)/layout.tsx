  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: ShoppingCart, label: 'สั่งซื้อ', href: '/clinic/inventory/orders', roles: ['clinic_owner', 'clinic_admin'] },
        { icon: Package, label: 'ซัพพลายเออร์', href: '/clinic/inventory/suppliers', roles: ['clinic_owner', 'clinic_admin'] },
