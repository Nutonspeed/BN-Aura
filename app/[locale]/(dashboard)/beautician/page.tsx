    ...
    >
        ...
        >
          <div className="px-6 py-3 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-6 backdrop-blur-md">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-bold text-white uppercase tabular-nums">3/8 Cases</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <ProtocolInsights customerId={activeCase?.customer_id || ''} />
          </motion.div>
          ...
          <AnimatePresence>
            {activeCase && (
              ...
              >
                ...
                <button className="p-8 glass-premium rounded-[40px] border border-white/5 hover:border-primary/40 transition-all group text-center relative overflow-hidden">
                  ...
                  <span className="text-[10px] font-black text-white uppercase tracking-[0.25em] group-hover:text-primary transition-colors">Request AI Re-scan</span>
                </button>
