...
export default function PredictiveDashboard() {
  ...
  // x: Engagement Score, y: Deal Value, z: Probability (color/size)
  ...
  // Mock Data for Conversion Funnel Prediction
  ...
  // Mock Data for Staff Performance Prediction
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
              ...
              />
              <Scatter name="Leads" data={leadsData} fill="#8884d8">
                {leadsData.map((entry, index) => (
                  <circle 
                    key={`cell-${index}`} 
                    cx="0" cy="0" r={entry.probability / 10} 
                ...
                <div className="flex-1">
                  ...
                  <div className="relative h-2 bg-black/20 rounded-full overflow-hidden">
                    ...
                    <div 
                      ...
                      style={{ width: `${staff.predicted}%`, zIndex: 1 }} // Overlap slightly or show predicted
                    />
                    {/* Actually better to show predicted as a marker or extension */}
                  </div>
