# 🏗️ SQL Schema Definition (Database Blueprint)

เอกสารชุดนี้สรุปโครงสร้างฐานข้อมูล PostgreSQL บน Supabase ทั้งหมด เพื่อให้ AI สามารถสร้าง Database ขึ้นใหม่ได้ตรงตามมาตรฐานเดิม 100%
